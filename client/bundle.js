...
})()(
  {
        ...
        function updateHabits(data) {
          ...
          updateButton.addEventListener("click", (e) => {
            ...
            for (const habit in data.tracked_habits) {
              ...
              var monCount = document.getElementById(`${habit}-Monday`).checked
                ? 1
                : 0;
              var tuesCount = document.getElementById(`${habit}-Tuesday`)
                .checked
                ? 1
                : 0;
              var wedCount = document.getElementById(`${habit}-Wednesday`)
                .checked
                ? 1
                : 0;
              var thursCount = document.getElementById(`${habit}-Thursday`)
                .checked
                ? 1
                : 0;
              var friCount = document.getElementById(`${habit}-Friday`).checked
                ? 1
                : 0;
              var weeklyCount =
                monCount + tuesCount + wedCount + thursCount + friCount;
    ...
    4: [
      ...
      },
      {
        ...
        "./habitForm": 3,
        "./src/js/handlers": 7,
        "./src/js/templates/loginForm": 9,
        "./src/js/templates/welcome": 10,
      },
    ],
    5: [
      function (require, module, exports) {
    ...
    7: [
      ...
      { "../../habitForm": 3, "../../selectHabits": 6, "./orgHelpers": 8 },
    ],
    8: [
      function (require, module, exports) {
